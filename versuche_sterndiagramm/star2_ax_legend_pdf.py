...
legende = [Line2D([0], [0], color='red', lw=3, label='♀ weiblich'),
           Line2D([0], [0], color='blue', lw=3, label='♂ männlich')]
ax.legend(handles=legende, loc='lower center', bbox_to_anchor=(0.5, -0.12),
...
# Layout und PDF speichern
plt.tight_layout()
fig.savefig("Unterrichtsangebot_nach_Geschlecht.pdf")
plt.show()
